...
const Hm = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <clipPath id="hm_svg__b">
        <path d="M0 0h6v3H0z" />
      </clipPath>
      <clipPath id="hm_svg__c">
      ...
      />
      <use xlinkHref="#hm_svg__a" id="hm_svg__d" transform="scale(2.1)" />
    </defs>
    ...
    <path
      ...
      strokeWidth={0.4}
      d="m0 0 6 3m0-3L0 3"
      clipPath="url(#hm_svg__c)"
      transform="scale(840)"
    />
    <path stroke="#fff" strokeWidth={840} d="M2520 0v2520M0 1260h5040" />
    <path stroke="#e4002b" strokeWidth={504} d="M2520 0v2520M0 1260h5040" />
    <g fill="#fff">
      <use xlinkHref="#hm_svg__d" x={2520} y={3780} />
      <use xlinkHref="#hm_svg__a" x={7560} y={4200} />
      <use xlinkHref="#hm_svg__a" x={6300} y={2205} />
      <use xlinkHref="#hm_svg__a" x={7560} y={840} />
      <use xlinkHref="#hm_svg__a" x={8680} y={1869} />
      <use xlinkHref="#hm_svg__e" x={8064} y={2730} />
    </g>
  </svg>
);
export default Hm;
